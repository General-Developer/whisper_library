...
class WhisperLibrary extends WhisperLibraryBase {
  ...
  bool loadWhisperModel({
    ...
    {
      WhisperLibrary._whisperLibraryDartSharedBindingsByGeneralDeveloper.whisper_log_set(
        Pointer.fromFunction(ggmlLogCallbackFunction),
        "log".toNativeUtf8().cast<Void>(),
      );
      WhisperLibrary._whisperLibraryDartSharedBindingsByGeneralDeveloper.ggml_log_set(
        Pointer.fromFunction(ggmlLogCallbackFunction),
        "log".toNativeUtf8().cast<Void>(),
      );
    }
    ...
    final whisperModelContext = _whisperLibraryDartSharedBindingsByGeneralDeveloper.whisper_init_from_file_with_params(
    ...
    _whisperLibraryDartSharedBindingsByGeneralDeveloper.whisper_ctx_init_openvino_encoder(
      whisperModelContext,
      nullptr,
  ...
  Future<Map> transcribeToJson({
    ...
    int maxContext = -1;
    final wparams = _whisperLibraryDartSharedBindingsByGeneralDeveloper.whisper_full_default_params(
    ...
    final int resultInference = () {
      if (nProccecors > 1) {
        return WhisperLibrary._whisperLibraryDartSharedBindingsByGeneralDeveloper.whisper_full_parallel(
          whisperModelContext,
          wparams,
          pointerFilePcm32,
          filePcm32.length,
    ...
    final Map resultJson = {
      ...
      "language": WhisperLibrary._whisperLibraryDartSharedBindingsByGeneralDeveloper
          .whisper_lang_str_full(
            WhisperLibrary._whisperLibraryDartSharedBindingsByGeneralDeveloper.whisper_full_lang_id(whisperModelContext),
          )
          .cast<Utf8>()
          .toDartString(),
